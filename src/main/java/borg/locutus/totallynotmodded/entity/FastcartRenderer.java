...
@OnlyIn(Dist.CLIENT)
public class FastcartRenderer<T extends AbstractMinecart> extends EntityRenderer<T> {
    private static final ResourceLocation FASTCART_LOCATION = new ResourceLocation(TotallyNotModdedMod.MODID, "textures/entity/fastcart.png");
    protected final EntityModel<T> model;
    private final BlockRenderDispatcher blockRenderer;

    public FastcartRenderer(EntityRendererProvider.Context p_174300_, ModelLayerLocation p_174301_) {
        super(p_174300_);
    ...
    public @NotNull ResourceLocation getTextureLocation(@NotNull T p_115416_) {
        return FASTCART_LOCATION;
    }
